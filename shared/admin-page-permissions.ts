...
export const ADMIN_PAGE_DEFINITIONS: AdminPageDefinition[] = [
  ...
  { key: 'game-maps', label: '服务器地图', route: '/game-maps', icon: 'map', defaultLevel: 'view', readOnly: true, maxNonOwnerLevel: 'view' },
...
export const ADMIN_FEATURE_DEFINITIONS: AdminFeatureDefinition[] = [
  ...
  {
    key: 'settings-mcsm',
    label: '站点设置：MCSM 面板与管理实例',
    icon: 'lan',
    description: '查看或修改 MCSManager 面板连接信息，并指定「服务器管理」与「服务器文件」共用的实例。',
    parentKey: 'settings',
    pageKey: 'settings',
    defaultLevel: 'hidden',
  },
  ...
  },
  {
    ...
    label: '服务器管理：实例高级设置',
    icon: 'tune',
    description: '查看和修改实例终端、Ping、RCON、自动启动与异步任务设置。',
    parentKey: 'server-manage',
    pageKey: 'server-manage',
    defaultLevel: 'hidden',
