...
@media(max-width:640px){.page-heading{align-items:stretch;flex-direction:column}.page-heading md-filled-button{width:100%}.download-table{min-width:620px}.download-table th:nth-child(5),.download-table td:nth-child(5){display:none}.dialog-form{width:100%;min-width:0}.actions{width:auto}}
</style>
