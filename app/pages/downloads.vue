...
<template>
  <div class="page">
    <div class="page-heading">
      <div><h1 class="page-title">下载项目</h1><p class="page-subtitle">维护官网展示的整合包和模组下载信息</p></div>
