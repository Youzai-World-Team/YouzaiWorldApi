...
const activityTableWrap = ref<HTMLElement | null>(null)
...
<template>
<div class="page page--wide catalog-page activity-page api-redesign-page">
    ...
    <section class="card catalog-card">
      ...
      <div ref="activityTableWrap" class="table-wrap">
      ...
      <AppScrollbar :target="activityTableWrap" axis="horizontal" label="服务器动态表格横向滚动条" />
      <EmptyState v-if="loading" :illustrated="false">加载中…</EmptyState>
      <EmptyState v-else-if="activities.length === 0" image="/images/empty-monitoring-data.svg">暂无记录</EmptyState>
    </section>
